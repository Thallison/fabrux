                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            <div class='form-group'>
                                ...
                                <select name="prod_ativo" id="prod_ativo_edit" class="form-select @error('prod_ativo') is-invalid @enderror" data-tom-select="true" data-tom-select-placeholder="Selecione um status" required>
