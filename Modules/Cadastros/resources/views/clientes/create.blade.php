...
<div class="card card-default mb-5">
    <div class="card-header header-elements-inline">
        <h5 class="card-title">{{ __('Novo Cliente') }}</h5>
        <div class="text-end header-elements ms-auto">
            <a href="{{ route('cadastros::clientes.index') }}" class="btn btn-info">
                <i class="bi bi-arrow-left"></i> {{ __('Voltar') }}
            </a>
        </div>
    </div>

    <form id="formCliente" method="post" action="{{ route('cadastros::clientes.store') }}">
        <div class="card-body">
            @csrf
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <label class="form-label">{{ __('Tipo de Pessoa') }} <span class="text-danger">*</span></label>
                    <div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="cli_tipo" id="tipo_fisico" value="F" {{ old('cli_tipo', 'F') === 'F' ? 'checked' : '' }} required>
                            <label class="form-check-label" for="tipo_fisico">{{ __('Pessoa Física') }}</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="cli_tipo" id="tipo_juridico" value="J" {{ old('cli_tipo') === 'J' ? 'checked' : '' }} required>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="cli_nome" class="form-label" id="label_cli_nome">{{ __('Nome Completo') }} <span class="text-danger">*</span></label>
                    <input type="text" id="cli_nome" name="cli_nome" class="form-control {{ $errors->has('cli_nome') ? 'is-invalid' : '' }}" placeholder="Digite o nome completo" value="{{ old('cli_nome') }}" required>
                ...
                <div class="col-md-6">
                    <label for="cli_cpf_cnpj" class="form-label" id="label_cli_cpf_cnpj">{{ __('CPF') }} <span class="text-danger">*</span></label>
                    <input type="text" id="cli_cpf_cnpj" name="cli_cpf_cnpj" class="form-control {{ $errors->has('cli_cpf_cnpj') ? 'is-invalid' : '' }}" placeholder="000.000.000-00" value="{{ old('cli_cpf_cnpj') }}" required>
            ...
            <div class="row mb-5" id="inscricoes-group" style="display: none;">
                <div class="col-md-6">
                    <label for="cli_ie" class="form-label">{{ __('Inscrição Estadual') }}</label>
                    <input type="text" id="cli_ie" name="cli_ie" class="form-control" placeholder="Ex: 123.456.789.012" value="{{ old('cli_ie') }}">
                </div>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <label for="cli_email" class="form-label">{{ __('Email') }} <span class="text-danger">*</span></label>
                    <input type="email" id="cli_email" name="cli_email" class="form-control {{ $errors->has('cli_email') ? 'is-invalid' : '' }}" placeholder="email@exemplo.com" value="{{ old('cli_email') }}" required>
            ...
            <div class="row mb-5">
                <div class="col-md-6">
                    <label for="cli_telefone" class="form-label">{{ __('Telefone') }}</label>
                    <input type="text" id="cli_telefone" name="cli_telefone" class="form-control" placeholder="(11) 3000-0000" value="{{ old('cli_telefone') }}">
                </div>
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    <label for="cli_cep" class="form-label">{{ __('CEP') }} <span class="text-danger">*</span></label>
                    <div class="input-group">
                        <input type="text" id="cli_cep" name="cli_cep" class="form-control {{ $errors->has('cli_cep') ? 'is-invalid' : '' }}" placeholder="00000-000" value="{{ old('cli_cep') }}" required>
            ...
            <div class="row mb-3">
                <div class="col-md-3">
                    <label for="cli_numero" class="form-label">{{ __('Número') }} <span class="text-danger">*</span></label>
                    <input type="text" id="cli_numero" name="cli_numero" class="form-control {{ $errors->has('cli_numero') ? 'is-invalid' : '' }}" placeholder="Ex: 123" value="{{ old('cli_numero') }}" required>
            ...
            <div class="row mb-3">
                <div class="col-md-5">
                    <label for="cli_bairro" class="form-label">{{ __('Bairro') }} <span class="text-danger">*</span></label>
                    <input type="text" id="cli_bairro" name="cli_bairro" class="form-control {{ $errors->has('cli_bairro') ? 'is-invalid' : '' }}" placeholder="Ex: Centro" value="{{ old('cli_bairro') }}" readonly>
                ...
                <div class="col-md-5">
                    <label for="cli_cidade" class="form-label">{{ __('Cidade') }} <span class="text-danger">*</span></label>
                    <input type="text" id="cli_cidade" name="cli_cidade" class="form-control {{ $errors->has('cli_cidade') ? 'is-invalid' : '' }}" value="{{ old('cli_cidade') }}" readonly>
                ...
                <div class="col-md-2">
                    <label for="cli_estado" class="form-label">{{ __('Estado') }} <span class="text-danger">*</span></label>
                    <input type="text" id="cli_estado" name="cli_estado" class="form-control {{ $errors->has('cli_estado') ? 'is-invalid' : '' }}" maxlength="2" placeholder="SP" value="{{ old('cli_estado') }}" readonly>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <div class="form-check mb-2">
                        ...
                        <input class="form-check-input" type="checkbox" id="cli_nao_contribuinte" name="cli_nao_contribuinte" value="1" {{ old('cli_nao_contribuinte', '0') === '1' ? 'checked' : '' }}>
                        <label class="form-check-label" for="cli_nao_contribuinte">{{ __('Não contribuinte ?') }}</label>
                    </div>

                    <div class="form-check mb-2">
                        <input type="hidden" name="cli_substituto_tributario_iss" value="0">
                        <input class="form-check-input" type="checkbox" id="cli_substituto_tributario_iss" name="cli_substituto_tributario_iss" value="1" {{ old('cli_substituto_tributario_iss', '0') === '1' ? 'checked' : '' }}>
                        <label class="form-check-label" for="cli_substituto_tributario_iss">{{ __('Substituto tributário ISS ?') }}</label>
                    </div>

                    <div class="form-check mb-2">
                        <input type="hidden" name="cli_nao_calcula_diferimento_icms" value="0">
                        <input class="form-check-input" type="checkbox" id="cli_nao_calcula_diferimento_icms" name="cli_nao_calcula_diferimento_icms" value="1" {{ old('cli_nao_calcula_diferimento_icms', '0') === '1' ? 'checked' : '' }}>
                        <label class="form-check-label" for="cli_nao_calcula_diferimento_icms">{{ __('Não calcula diferimento de ICMS ?') }}</label>
                    </div>

                    <div class="form-check mb-2">
                        <input type="hidden" name="cli_apura_icms" value="0">
                        <input class="form-check-input" type="checkbox" id="cli_apura_icms" name="cli_apura_icms" value="1" {{ old('cli_apura_icms', '0') === '1' ? 'checked' : '' }}>
                        <label class="form-check-label" for="cli_apura_icms">{{ __('Apura ICMS ?') }}</label>
                    </div>

                    <div class="form-check mb-2">
                        <input type="hidden" name="cli_aliquota_icms_diferenciada_contribuinte" value="0">
                        <input class="form-check-input" type="checkbox" id="cli_aliquota_icms_diferenciada_contribuinte" name="cli_aliquota_icms_diferenciada_contribuinte" value="1" {{ old('cli_aliquota_icms_diferenciada_contribuinte', '0') === '1' ? 'checked' : '' }}>
                        <label class="form-check-label" for="cli_aliquota_icms_diferenciada_contribuinte">{{ __('Alíquota de ICMS diferenciada contribuinte ?') }}</label>
                    </div>
                </div>
            </div>
        ...
        <div class="card-footer text-end">
            ...
            <a href="{{ route('cadastros::clientes.index') }}" class="btn btn-secondary">{{ __('Cancelar') }}</a>
        </div>
    </form>
</div>
...
<script>
    ...
    function updateCpfCnpjMask() {
        ...
        if (tipo === 'F') {
            labelNome.innerHTML = '{{ __("Nome Completo") }} <span class="text-danger">*</span>';
