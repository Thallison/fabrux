    ...
    <div class="col-md-12">
        <div class="card" >
            <div class="card-header header-elements-inline">
                <h5 class="card-title">{{ __('Cadastrar Grupo') }}</h5>
                <div class="text-end">
            ...
            <div class="card-body">
                <form action="{{ route('seguranca::papeis.store') }}" method="POST" id="formPapel">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class='form-group'>
                                <label class="form-label">{{ __($model->getAttributeLabel('papel_nome')) }} : <span class="text-danger">*</span></label>
                                <input class="form-control @error('papel_nome') is-invalid @enderror" type="text" name="papel_nome" required  placeholder="{{ __($model->getAttributeLabel('papel_nome')) }}" value="{{ old('papel_nome') }}" />
                                @error('papel_nome')
